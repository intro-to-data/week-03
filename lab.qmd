...
2. Spend a few minutes looking at the data. The "Environment" pane is on the lower right-hand side of the RStudio Desktop interface. Click on "abnb" to open the data in a new editor tab. This makes it easier to explore
...
```{r}
## Three solutions!
abnb |> filter(neighbourhood_group == ?)
